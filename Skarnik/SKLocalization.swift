...
class SKLocalization: Any {
    ...
    class var aboutSupportHtml: String {"Праекту патрэбна дапамога. Dev, ML, UI, Marketing, можаце нават грашыма падтрымаць. Прапановы пісаць <a href=\"mailto:belanghelp@gmail.com\">сюды</a>."}
